...
for csv = files
    ...
    %Loop through all days
     ...
     figure_name=string(strcat('Measured Data of Subject ',csv));
     figure('Name',figure_name);
     t = tiledlayout(3,2);

     %Visualize both the orthonormal principal component coefficients  in a single plot
     vbls= {'v_1','v_2','v_3','v_4','v_5','v_6','v_7','v_8','v_9','v_10','v_11','v_12','v_13','v_14','v_15','v_16','v_17','v_18'};
     nexttile;
     biplot(coeff(1:18,1:2),'scores',score(1:18,1:2),'varlabels',vbls);

     %Visualize both the orthonormal principal component coefficients  of 5 vectors in a single plot
     vbls1= {'v_1','v_2','v_3','v_4','v_5'};
     nexttile;
     biplot(coeff(1:5,1:2),'scores',score(1:5,1:2),'varlabels',vbls1);
     ...
     %plot the values
     nexttile;
     plot(days,dataInPrincipalComponentSpace);
